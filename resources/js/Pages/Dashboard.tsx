...
function Dashboard({ auth, datas, date }: any) {
    const { data, get, processing, errors, setData } = useForm({
        date: date
    });
    ...
    const filter = (e) => {
        e.preventDefault();
        Inertia.get(route("dashboard", { date: data.date }));
    };
    useEffect(() => {}, [setQuery, auth, query, datas]);
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-8">
                                ...
                                <form>
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            disabled={processing}
                                            onClick={filter}
                                            className="rounded-lg bg-blue-500 px-4 text-white hover:bg-blue-700 transition-colors "
                                        >
                                            Filter
                                        </button>
                                    </div>
                            ...
                            <div className="pagination mt-5 noCetak">
                                {datas.links.map((link: any, index: any) => (
                                    <a
                                        key={index}
                                        href={link.url}
